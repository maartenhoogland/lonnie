    ...
    function handleTabsFAQ() {
        if($('#tabs-faq').length){
            ...
            tabs.find('a').on('click', function () {
                tabs.find('.fa-angle-right').removeClass('fa-angle-right').addClass('fa-angle-right');
                $(this).find('.fa').removeClass('fa-angle-right').addClass('fa-angle-right');
            });
        }
    }
        ...
        initGoogleMap: function() {
            ...
            function initialize() {
                var mapOptions = {
                    scrollwheel: false,
                    zoom: 9,
                    center: new google.maps.LatLng(48.756593, 2.171669)
                };
